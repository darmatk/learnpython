...
class App(tkinter.Tk):
	...
	def __init__(self, *args, **kwargs):
		...
		self.search_bar_button = tkinter.Button(master=self,
												width=8,
												text="Cari",
												command=self.search)
		self.search_bar_button.grid(row=0, column=1, pady=10, padx=10)

		self.search_bar_clear = tkinter.Button(master=self, width=8, text="Bersihkan", command=self.clear)
		self.search_bar_clear.grid(row=0, column=2, pady=10, padx=10)

		self.map_widget = TkinterMapView(width=self.WIDTH, height=400, corner_radius=0)
		...
		self.listbox_button_frame = tkinter.Frame(master=self, bg="#464646")
		...
		self.save_marker_button = tkinter.Button(master=self.listbox_button_frame, width=20, text="Simpan Marker",
												command=self.save_marker)
		self.save_marker_button.grid(row=0, column=0, pady=10, padx=10)

		self.clear_marker_button = tkinter.Button(master=self.listbox_button_frame, width=20, text="Bersihkan Marker",
												command=self.clear_marker_list)
		self.clear_marker_button.grid(row=1, column=0, pady=10, padx=10)

		self.connect_marker_button = tkinter.Button(master=self.listbox_button_frame, width=20, text="Hubungkan Marker",
		...
		self.map_widget.set_position(-8.579025, 115.301351) #Peta Bali
